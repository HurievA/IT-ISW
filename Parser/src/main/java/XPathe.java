...
public class XPathe {
    ...
    public static void run(Document doc, XPath xPath) throws XPathExpressionException {
        one(doc, xPath);
        two(doc, xPath);
        three(doc, xPath);
        four(doc, xPath);
    ...
    public static void one(Document doc, XPath xPath) throws XPathExpressionException {
        XPathExpression exp = xPath.compile("/Array/dishes");
    ...
    public static void two(Document doc, XPath xPath) throws XPathExpressionException {
        XPathExpression exp = xPath.compile("/Array/dishes/@count");
        NodeList list = (NodeList) exp.evaluate(doc, XPathConstants.NODESET);
        System.out.println("Вивести інформацію за однією із характеристик для всіх описаних складних елементів ");
    ...
    public static void three(Document doc, XPath xPath) throws XPathExpressionException {
        XPathExpression exp = xPath.compile("/Array/dishes[@count=99]/name/text()");
        NodeList list = (NodeList) exp.evaluate(doc, XPathConstants.NODESET);
    ...
    public static void four(Document doc, XPath xPath) throws XPathExpressionException {
        XPathExpression exp = xPath.compile("/Array/dishes/name[string-length() > 1]/text()");
        NodeList list = (NodeList) exp.evaluate(doc, XPathConstants.NODESET);
    ...
    public static void five(Document doc, XPath xPath) throws XPathExpressionException {
        XPathExpression exp = xPath.compile("/Array/dishes[1]/*[1]/text()");
        NodeList list = (NodeList) exp.evaluate(doc, XPathConstants.NODESET);
    ...
    public static void six(Document doc, XPath xPath) throws XPathExpressionException {
        XPathExpression exp = xPath.compile("/Array/dishes[1]/*[2]/text()");
        NodeList list = (NodeList) exp.evaluate(doc, XPathConstants.NODESET);
    ...
    public static void seven(Document doc, XPath xPath) throws XPathExpressionException {
        XPathExpression exp = xPath.compile("/Array/dishes[1]/*[3]/text()");
        NodeList list = (NodeList) exp.evaluate(doc, XPathConstants.NODESET);
    ...
    public static void eight(Document doc, XPath xPath) throws XPathExpressionException {
        XPathExpression exp = xPath.compile("/Array/dishes[/Array/dishes/detail/id > 10000 and /Array/dishes/detail/id < 15000 and contains(name, 'СУ')]/name/text()");
        NodeList list = (NodeList) exp.evaluate(doc, XPathConstants.NODESET);
    ...
    public static void nine(Document doc, XPath xPath) throws XPathExpressionException {
        XPathExpression exp = xPath.compile("/Array/dishes[position() mod 5 = 0]/cost/text() | /Array/dishes[position() mod 5 = 0]/weight/text()");
        NodeList list = (NodeList) exp.evaluate(doc, XPathConstants.NODESET);
    ...
    public static void ten(Document doc, XPath xPath) throws XPathExpressionException {
        XPathExpression exp = xPath.compile("/Array/dishes[position() mod 2 = 0]/@count | /Array/dishes[position() mod 2 = 0]/cost/text()");
        NodeList list = (NodeList) exp.evaluate(doc, XPathConstants.NODESET);
